...
public class TextGlow : BaseMeshEffect
{
    ...
    private static readonly List<UIVertex> s_tempVertices = new List<UIVertex>(32);
    public override void ModifyMesh(VertexHelper _vh)
    {
        ...
        for (var i = 0; i <= s_tempVertices.Count - 3; i += 3)
        {
            ...
            //    vertex.uv0 += vecUvY / vecYLen * addY * signY;
                ...
                vertex.uv1.x = m_size;// Mathf.Abs(vertex.uv1.x);
                vertex.uv1.y = m_size;//Mathf.Abs(vertex.uv1.y);
