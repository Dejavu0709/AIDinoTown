// Minimalistic JSON parser and serializer (MIT License)
// Source: https://gist.github.com/darktable/1411710 (trimmed)
using System;
...
namespace MiniJSON
{
    ...
    // Simple StringReader implementation to avoid System.IO dependency in some platforms
    internal class StringReader : IDisposable
    {
        string s; int pos = 0;
        public StringReader(string s) { this.s = s ?? string.Empty; }
        public int Peek() { return pos >= s.Length ? -1 : s[pos]; }
        public int Read() { return pos >= s.Length ? -1 : s[pos++]; }
        public void Dispose() { s = null; }
    }
}
